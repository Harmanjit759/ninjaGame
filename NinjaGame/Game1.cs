...
namespace NinjaGame
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            base.Initialize();
            level = new Level(this, controller, font);
        }
        ...
        protected override void LoadContent()
        {
            ...
            SoundEffectsFactory.Init(Content);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //fireball.Draw(spriteBatch,new Vector2(100f,100f));
            //spell.Draw(spriteBatch, new Vector2(550f, 100f));
